...
// `Sequence_Primitives` and `Iterable` are imported directly by this module's own
// source files (Vector+Iterable.swift, Vector+Sequence.Properties.swift) and are
// re-exported here so the conformances' associated `Iterable` / `Sequenceable`
// surface is visible to consumers through the umbrella.
